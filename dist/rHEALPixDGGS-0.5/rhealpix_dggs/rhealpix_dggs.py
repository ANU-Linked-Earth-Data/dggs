...
class RHEALPixDGGS(object):
    ...
    def healpix(self, u, v, inverse=False):
        ...
        """
        f = projection_wrapper.Proj(ellipsoid=self.ellipsoid, proj='healpix')
    ...
    def rhealpix(self, u, v, inverse=False):
        ...
        """
        f = projection_wrapper.Proj(ellipsoid=self.ellipsoid, proj='rhealpix',              
    ...
    def combine_triangles(self, u, v, inverse=False):
        ...
        u, v = array((u, v))/R_A
        # Combine triangles.
        u, v = pj_rhealpix.combine_triangles(u, v, inverse=inverse, 
    ...
    def triangle(self, x, y, inverse=True):
        ...
        x, y = array((x, y))/R_A
        # Get triangle.
        return pj_rhealpix.triangle(x, y, inverse=inverse, 
                                    north_square=ns, south_square=ss)

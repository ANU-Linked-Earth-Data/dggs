...
sys.path.insert(0, os.path.abspath('../../rhealpix_dggs'))
...
project = u'rHEALPixDGGS'
copyright = u'2013, Alexander Raichev'
...
htmlhelp_basename = 'rHEALPixDGGSdoc'
...
latex_documents = [
  ('index', 'rHEALPixDGGS.tex', u'rHEALPixDGGS Documentation',
   u'Alexander Raichev', 'manual'),
]
...
man_pages = [
    ('index', 'rHEALPixDGGS', u'rHEALPixDGGS Documentation',
     [u'Alexander Raichev'], 1)
]
...
texinfo_documents = [
  ('index', 'rHEALPixDGGS', u'rHEALPixDGGS Documentation',
   u'Alexander Raichev', 'rHEALPixDGGS', 'One line description of project.',
   'Miscellaneous'),
]
